...
| Modell | Parameter | Hinweis |
|--------|-----------|---------|
| GPT-2 | 124M | Klassisches Lehrmodell (hier verwendet) |
| Qwen2.5-0.5B-Instruct | 500M | Modern, mehrsprachig, bessere Qualität |
| SmolLM2-135M-Instruct | 135M | Winzig, schnell, moderne Architektur |
| GPT-5.5 | ~1,8T | State-of-the-art (nur via API) |
